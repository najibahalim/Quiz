...
public class FstudGive extends AppCompatActivity {
    public static int codeq;
    ProgressDialog progressDialog;
    Zdata da=new Zdata();
    ConnectionClass connectionClass;
    private FstudGive.Connt mAuthTask=null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstud_give);
       final EditText code=(EditText)findViewById(R.id.editText2);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                codeq=Integer.valueOf(code.getText().toString());
                if(mAuthTask==null)
                {
                    mAuthTask=new FstudGive.Connt(codeq);
                    mAuthTask.execute("");
                }
            }
        });
    ...
    public class Connt extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (isSuccess) {
                Intent intent = new Intent(FstudGive.this, Display.class);
